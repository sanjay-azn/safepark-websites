...
export default function HomePage() {
  ...
  return (
    <div className="scroll-smooth bg-white min-h-screen overflow-x-hidden">
      
      {/* HERO SECTION */}
      <section className="min-h-screen flex items-center px-6 md:px-12 lg:px-20 relative overflow-hidden py-16 bg-gradient-to-br from-white to-slate-50">
        
        {/* Animated Background Orbs */}
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute top-0 -right-40 w-80 h-80 bg-gradient-to-br from-emerald-100 to-cyan-50 rounded-full blur-3xl animate-blob-1" style={{ animationDelay: '0s' }}></div>
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-cyan-100 to-emerald-50 rounded-full blur-3xl animate-blob-2" style={{ animationDelay: '2s' }}></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto w-full relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left space-y-6">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 font-medium text-sm hover:bg-emerald-100 transition-all duration-300 w-fit fade-in-1">
                <div className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse"></div>
                Made in India • Premium Quality
              </div>

              <div className="space-y-3">
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-gray-900 fade-in-2">
                  Everyday Risks.
                </h1>
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-emerald-600 via-cyan-600 to-emerald-700 bg-clip-text text-transparent fade-in-3">
                  Lasting Protection.
                </h2>
              </div>
              
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-xl font-light fade-in-4">
                Your car faces <span className="text-gray-900 font-semibold">hidden threats every day</span>. From unexpected weather to kids playing nearby, give yourself <span className="text-emerald-600 font-medium">complete peace of mind</span>.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4 fade-in-5">
                ...
                <a 
                  href="#gallery"
                  className="px-8 py-3 rounded-xl border-2 border-emerald-500 text-emerald-600 font-bold text-base hover:bg-emerald-50 transition-all duration-300 inline-flex items-center justify-center gap-2 group btn-lift"
                >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 pt-4 fade-in-6">
                <div className="flex items-center gap-3 card-float">
                  ...
                  <span className="text-gray-700 text-sm font-medium">2,000+ Protected Cars</span>
                </div>
              ...
              <div className="flex flex-wrap gap-4 pt-4 text-xs text-gray-600 fade-in-7">
            ...
            <div className="flex justify-center lg:justify-end order-first lg:order-last parallax fade-in-image">
              <div className="relative w-full max-w-[500px] group">
                <div className="absolute inset-0 bg-gradient-to-tr from-emerald-400/30 via-cyan-400/20 to-emerald-400/20 rounded-3xl blur-3xl group-hover:opacity-100 opacity-70 transition-opacity duration-500 animate-glow"></div>
                <div className="absolute -inset-2 bg-gradient-to-r from-emerald-400/20 to-cyan-400/20 rounded-3xl blur-2xl opacity-50"></div>
                
                <img 
                  src="/gallery/hero-car.jpeg" 
                  alt="Premium car protected by SafePark"
                  className="relative w-full h-[350px] md:h-[420px] object-cover rounded-3xl shadow-2xl border border-gray-200 group-hover:border-emerald-400/50 group-hover:shadow-emerald-400/20 transition-all duration-500 img-zoom"
                  loading="eager"
                />
      ...
      {/* FEATURES */}
      <section className="py-24 px-6 md:px-12 lg:px-20 relative bg-white">
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-50/50 via-transparent to-cyan-50/50 -z-10"></div>
        
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 scroll-observe space-y-4">
            <h2 className="text-5xl md:text-6xl font-bold text-gray-900 heading-reveal">Complete Protection</h2>
            <p className="text-lg text-gray-600 font-light max-w-2xl mx-auto text-reveal">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: <Shield className="w-12 h-12 text-red-500" />, title: "Fire Protection", desc: "Heat & flame resistant", gradient: "from-red-50 to-orange-50" },
              { icon: <Umbrella className="w-12 h-12 text-blue-500" />, title: "Rain Protection", desc: "100% waterproof coating", gradient: "from-blue-50 to-cyan-50" },
              { icon: <Zap className="w-12 h-12 text-yellow-500" />, title: "Scratch-Proof", desc: "Military-grade fabric", gradient: "from-yellow-50 to-amber-50" },
              { icon: <UserCheck className="w-12 h-12 text-green-500" />, title: "Safe for Kids", desc: "Family-friendly design", gradient: "from-green-50 to-emerald-50" }
            ].map((feature, idx) => (
              <div 
                key={idx}
                className="scroll-observe group relative p-6 rounded-2xl bg-white border border-gray-200 hover:border-emerald-300 transition-all duration-500 hover:bg-gray-50 hover:-translate-y-2 hover:shadow-lg card-stagger"
              ...
              >
                ...
                <div className="flex flex-col items-center text-center space-y-3">
                  <div className="p-3 rounded-xl bg-gray-50 group-hover:bg-gray-100 transition-colors duration-300 icon-bounce" style={{ animationDelay: `${idx * 150}ms` }}>
                    {feature.icon}
                  </div>
      ...
      {/* VALUE PROPS */}
      <section className="py-24 px-6 md:px-12 lg:px-20 relative bg-gradient-to-br from-slate-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 scroll-observe space-y-4">
            <h2 className="text-5xl md:text-6xl font-bold text-gray-900 heading-reveal">Why Choose SafePark?</h2>
            <p className="text-lg text-gray-600 font-light max-w-2xl mx-auto text-reveal">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={idx}
                className="scroll-observe group relative p-8 rounded-2xl bg-white border border-gray-200 hover:border-emerald-300 transition-all duration-500 hover:bg-gray-50 hover:-translate-y-2 card-slide"
                style={{ animationDelay: `${idx * 150}ms` }}
              >
                <div className="absolute -top-4 right-6 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-bold badge-scale">
                  {item.badge}
                </div>

                <div className="space-y-4">
                  <div className="w-12 h-12 rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-600 group-hover:scale-110 group-hover:bg-emerald-100 transition-all duration-300 icon-spin">
                    {item.icon}
                  </div>
      ...
      {/* GALLERY */}
      <section id="gallery" className="py-24 px-6 md:px-12 lg:px-20 bg-white relative">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 scroll-observe space-y-4">
            <h2 className="text-5xl md:text-6xl font-bold text-gray-900 heading-reveal">See SafePark in Action</h2>
            <p className="text-lg text-gray-600 font-light text-reveal">Real installations, real results</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div 
                key={idx}
                className="scroll-observe group relative rounded-2xl overflow-hidden bg-white border border-gray-200 hover:border-emerald-300 transition-all duration-500 hover:-translate-y-2 gallery-item"
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3 px-2 py-1 bg-emerald-500 text-white text-xs font-bold rounded-lg tag-pop">{item.tag}</div>
                </div>
                
                <div className="p-4">
                  <h3 className="text-gray-900 font-bold text-sm group-hover:text-emerald-600 transition-colors">{item.caption}</h3>
                  <p className="text-emerald-600 text-xs mt-1">Professional Installation</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 px-6 md:px-12 lg:px-20 relative bg-gradient-to-br from-slate-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 scroll-observe space-y-4">
            <h2 className="text-5xl md:text-6xl font-bold text-gray-900 heading-reveal">Trusted by Thousands</h2>
            <p className="text-lg text-gray-600 font-light text-reveal">Real satisfaction from real customers</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div 
                key={idx}
                className="scroll-observe group p-6 rounded-2xl bg-white border border-gray-200 hover:border-emerald-300 transition-all duration-500 hover:bg-gray-50 hover:-translate-y-2 testimonial-flip"
                style={{ animationDelay: `${idx * 150}ms` }}
              >
                ...
                <p className="text-gray-700 text-sm leading-relaxed mb-4 italic text-fade">"{review.text}"</p>
                
                <div className="border-t border-gray-200 pt-4">
                  <p className="font-bold text-gray-900 text-sm">{review.name}</p>
                  <p className="text-xs text-gray-600">{review.role} • {review.location}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 px-6 md:px-12 lg:px-20 relative bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="relative scroll-observe cta-scale">
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-100/50 via-cyan-100/50 to-emerald-100/50 rounded-3xl blur-2xl opacity-60"></div>
            
            <div className="relative bg-white border border-gray-200 rounded-3xl p-12 text-center space-y-6">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 heading-reveal">Ready to Protect Your Vehicle?</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto font-light text-reveal">
              ...
              <div className="grid md:grid-cols-3 gap-8 py-8 border-y border-gray-200">
                {[
                  ...
                  <div key={i} className="group/contact contact-pop" style={{ animationDelay: `${i * 100}ms` }}>
                    <div className="w-12 h-12 rounded-full bg-emerald-50 flex items-center justify-center mx-auto mb-3 text-emerald-600 group-hover/contact:bg-emerald-100 transition-colors">
                      {contact.icon}
                    </div>
                    <p className="text-sm text-gray-600 mb-1">{contact.title}</p>
                    {contact.href ? (
                      <a href={contact.href} className="text-emerald-600 hover:text-emerald-700 font-semibold transition-colors">
                        {contact.content}
                      </a>
                    ) : (
                      <p className="text-emerald-700 font-semibold">{contact.content}</p>
                    )}
                  </div>
                ))}
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 fade-in-buttons">
                ...
                <a 
                  ...
                  className="px-8 py-3 rounded-xl border-2 border-emerald-500 text-emerald-600 font-bold hover:bg-emerald-50 transition-all duration-300 btn-pulse"
      ...
      {/* FOOTER */}
      <footer className="border-t border-gray-200 bg-gray-50 py-16 px-6 md:px-12 lg:px-20">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 mb-12">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-2xl font-bold text-gray-900">SafePark</span>
              </div>
              ...
              <p className="text-sm text-gray-600">2,000+ Happy Customers</p>
            </div>
