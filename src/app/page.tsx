...
export default function HomePage() {
  ...
  return (
   ...
   {/* HERO SECTION - EXPANDED & STYLED LIKE REFERENCE */}
<section className="py-24 lg:py-32 px-6 md:px-12 lg:px-20 relative overflow-hidden">
  <div className="absolute inset-0 -z-10 overflow-hidden">
    {/* Dark teal to black gradient background */}
    <div className="absolute inset-0 bg-gradient-to-b from-slate-900/80 via-black to-slate-950"></div>
    {/* Add more teal/cyan tint for that reference feel */}
    <div className="absolute inset-0 bg-gradient-to-r from-teal-950/40 via-black to-cyan-950/30 opacity-60"></div>
    
    <div className="absolute top-0 -right-40 w-[600px] h-[600px] bg-gradient-to-br from-emerald-500/50 via-cyan-500/35 to-transparent rounded-full blur-3xl animate-blob-1"></div>
    <div className="absolute bottom-0 -left-40 w-[600px] h-[600px] bg-gradient-to-tr from-cyan-500/50 via-emerald-500/35 to-transparent rounded-full blur-3xl animate-blob-2"></div>
    <div className="absolute top-1/3 left-1/3 w-[500px] h-[500px] bg-gradient-to-br from-emerald-400/25 via-cyan-400/20 to-transparent rounded-full blur-3xl animate-blob-3"></div>
    <div className="absolute inset-0 bg-[linear-gradient(rgba(16,185,129,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(16,185,129,0.1)_1px,transparent_1px)] bg-[size:50px_50px] [mask-image:radial-gradient(ellipse_120%_80%_at_50%_50%,black,transparent)]"></div>
  </div>
  ...
  <div className="max-w-7xl mx-auto w-full relative z-10">
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-center">
      ...
      <div className="lg:col-span-5 text-center lg:text-left space-y-6">
        ...
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-tight text-white animate-fade-in-up drop-shadow-xl" style={{ animationDelay: '0.1s' }}>
          Your Car<br className="hidden md:block" /> Deserves<br className="hidden md:block" /> <span className="bg-gradient-to-r from-emerald-300 via-cyan-300 to-emerald-400 bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(16,185,129,0.8)]">SafePark.</span>
        </h1>
        
        <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-lg font-light animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-4 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          ...
          <a href="#gallery" className="relative px-8 py-3.5 rounded-xl border-2 border-emerald-400/80 bg-emerald-500/15 text-emerald-200 font-bold text-sm md:text-base hover:bg-emerald-500/25 hover:border-emerald-300 hover:text-emerald-100 hover:shadow-lg hover:shadow-emerald-500/40 transition-all duration-300 inline-flex items-center justify-center gap-2 group backdrop-blur-sm overflow-hidden">
      ...
      <div className="lg:col-span-7 flex justify-center lg:justify-end order-first lg:order-last parallax" style={{ animation: 'zoom-in 1s cubic-bezier(0.34, 1.56, 0.64, 1) 0.3s both' }}>
        <div className="relative w-full max-w-[580px] h-[480px] group">
          <div className="absolute -inset-2 bg-gradient-to-r from-emerald-500/70 via-cyan-500/50 to-emerald-500/70 rounded-3xl blur-3xl group-hover:blur-3xl opacity-70 group-hover:opacity-90 transition-all duration-500 animate-pulse-slow"></div>
          <div className="absolute inset-0 bg-gradient-to-tr from-emerald-500/40 via-cyan-500/30 to-emerald-500/40 rounded-3xl blur-2xl group-hover:opacity-100 opacity-70 transition-opacity duration-500"></div>
          
          <img src="/gallery/gallery1.jpg" alt="SafePark retractable carport in action" className="relative w-full h-full object-cover rounded-3xl shadow-2xl border-2 border-emerald-400/70 group-hover:border-emerald-300/90 group-hover:shadow-3xl group-hover:shadow-emerald-500/70 transition-all duration-500 group-hover:scale-[1.02]" loading="eager" />
        </div>
      </div>
    </div>
  </div>
